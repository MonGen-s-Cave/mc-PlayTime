...
public class MySQL implements Database {
    ...
    @Override
    public CompletableFuture<PlayerData> getPlayerData(@NotNull UUID uuid, @NotNull String server) {
    ...
    @Override
    public CompletableFuture<ConcurrentHashMap<String, Long>> getTopPlayers(@NotNull String server, int limit) {
        return CompletableFuture.supplyAsync(() -> {
    ...
    @Override
    public CompletableFuture<Long> getTotalOnlineTime(@NotNull UUID uuid) {
        return CompletableFuture.supplyAsync(() -> {
